...
* add application icon files for branding ([6de6a96](https://github.com/asieduernest12/occ/commit/6de6a96378d3100b2f66d7a311d56f12ce0c032a))
* add cdp Makefile target for Chrome DevTools Protocol ([e5a44e7](https://github.com/asieduernest12/occ/commit/e5a44e7f231b5e57a536ed6f8213841f743a47de))
* Add error code definitions and error modal component ([7d133c7](https://github.com/asieduernest12/occ/commit/7d133c752d231a6a668492356b684302c5ee3d52))
* Add error message display to Docker setup wizard ([c9f515d](https://github.com/asieduernest12/occ/commit/c9f515dc33ae8be8d190ee4e10bd2f7f1099d84d))
* add gateway.proxyUrl config support for custom gateway URLs ([1977eb6](https://github.com/asieduernest12/occ/commit/1977eb61052e02851a0db9e03f1ce6aa9b67d418))
* add global teardown hook to close all browser tabs after tests ([14d9a24](https://github.com/asieduernest12/occ/commit/14d9a242e6a4a3be8a61deeb130d932bc82821e5))
* add Phase 1 self-healing to make launch for permission resilience ([e47a4cd](https://github.com/asieduernest12/occ/commit/e47a4cd78122f37efcfd95f6181b810e57ce7f92))
* **billing:** implement OCC Credits card and balance display components ([71062bc](https://github.com/asieduernest12/occ/commit/71062bc4b20588e215907ac4a8987bacabc85b37))
* Display product version from version.txt in OCC Home panel ([b7272d2](https://github.com/asieduernest12/occ/commit/b7272d20179bfab2d52b32bf39b3b247463ef5f4))
* **docker-setup:** implement input validation and error reporting ([8441267](https://github.com/asieduernest12/occ/commit/84412678c2847794332d23b801d3d82a46552bbc))
* **docker-setup:** migrate from docker run to docker-compose ([42b3e07](https://github.com/asieduernest12/occ/commit/42b3e071d74dfbc701608212caac22ba1e946190))
* **docker:** add bind host config, switch to host networking ([24625ce](https://github.com/asieduernest12/occ/commit/24625ce116396a10a48b67e722cdbddebe14d78f))
* **docker:** auto-configure occ-legacy on Docker install, skip API key prompt ([518834d](https://github.com/asieduernest12/occ/commit/518834dc0327abf530b68b0670c67095af5ac89c))
* **docker:** rewrite setup wizard to use official openclaw image ([62924cd](https://github.com/asieduernest12/occ/commit/62924cde6e3d4c9ef6083eb8489a9deceb36a4d5))
* extract StatusPanelController + show full status panel in adapter tabs ([43b7654](https://github.com/asieduernest12/occ/commit/43b76542bad3dce269dd6caac539131767547cf9))
* **gateway-info:** add gateway status display component with collapsed UI ([ef50d8b](https://github.com/asieduernest12/occ/commit/ef50d8bbf02c294546ed42f0afe8c08b37d58aa7))
* **gateway-info:** add retry logic and transient error handling ([9eb4248](https://github.com/asieduernest12/occ/commit/9eb42482220c4943b47ebb5391fcbcb87f5007b5))
* **home:** add bind host config to Docker 3-step flow ([5ba1cfd](https://github.com/asieduernest12/occ/commit/5ba1cfd972c8a59fee4118a5863721d72c0d7f0f))
* Implement error collection and reporting system ([c8b2a0a](https://github.com/asieduernest12/occ/commit/c8b2a0a9fabb092b98bfa64136fa4e5d3e2693c3))
* **multihost:** add shared host types + adapter extension scaffolds ([5304d12](https://github.com/asieduernest12/occ/commit/5304d1214e33558d8fbef61e18aed22d22952250))
* **multihost:** HostRegistry, HostManager, status bar, tree provider, API export ([f2a34a6](https://github.com/asieduernest12/occ/commit/f2a34a6c74cbccda3fbea029be55373685096a93))
* **multihost:** openclaw-docker extension + openclaw-ssh stub ([88ba537](https://github.com/asieduernest12/occ/commit/88ba53786ffebeea87680e2716848182fed075e2))
* **multihost:** openclaw-local extension — LocalHostAdapter + LocalHostConnection ([9dc166a](https://github.com/asieduernest12/occ/commit/9dc166a82593b843c03ea16faaffe8bb2bfe5777))
* **multihost:** Phase 2b — home.ts surgical refactor to HostConnection ([d8814d5](https://github.com/asieduernest12/occ/commit/d8814d5af49636e02aa905552b1623635e80d3d5))
* **openclaw-docker:** embed compose file, restore on first run if missing ([329ea92](https://github.com/asieduernest12/occ/commit/329ea9214c624c15c6355a814b79b860dcafc11c))
* **openclaw:** open web panel with token instead of external browser ([c9f877f](https://github.com/asieduernest12/occ/commit/c9f877f52ac42926778cba8b40236cb1ce5c2424))
* smart host routing + dual status panel titles + hosts overview ([2297c2c](https://github.com/asieduernest12/occ/commit/2297c2c0358f399cdfd1c6a3f4738e5707d4e11b))
* **ticket-040:** add 3-step Docker config modal to Home panel ([fb5f691](https://github.com/asieduernest12/occ/commit/fb5f69104238170b184578bce6d49c339f270abc))
* **ticket-040:** replace modal docker config with full-page step views ([5dec2a1](https://github.com/asieduernest12/occ/commit/5dec2a1a2bc150a3bff9ab488ad77e842e07d6ca))
* **ticket-045:** add error reporting for Docker provisioning failures ([fcbc13f](https://github.com/asieduernest12/occ/commit/fcbc13f2157d38907cf929ac25acd3f2a854152f))
* **ticket-046:** add Docker config flow to DockerSetupPanel ([46e7181](https://github.com/asieduernest12/occ/commit/46e718183ef773db25864e676afb8fa55183e90f))
* **ticket-047:** implement startup flow BDD spec and E2E test ([67a24ba](https://github.com/asieduernest12/occ/commit/67a24ba366aeeced0aa62a89df55d4e2291769aa))
* **ticket-047:** strengthen E2E tests and integrate proxyUrl validation ([bb90547](https://github.com/asieduernest12/occ/commit/bb905470a741c6002fb18f9733e4ef027e5b33fc))
* window-level host binding — one host per VS Code window ([0a1825a](https://github.com/asieduernest12/occ/commit/0a1825aad1ff570dee4695f6705312876605a665))


### Bug Fixes

* Add comprehensive debugging for Docker config flow ([802c333](https://github.com/asieduernest12/occ/commit/802c333b65808c2efad73d85ec327860ec42b8d6))
* add CSS loader to esbuild configuration to prevent MIME type errors ([933e067](https://github.com/asieduernest12/occ/commit/933e0673a24c7ae71766b028529a5f863acdd924))
* add mode option to gulp.dest() calls to prevent permission errors ([82da79d](https://github.com/asieduernest12/occ/commit/82da79de628db9eab469c429fdc5d077638661d0))
* **build:** add codeWeb entry point to web bundle task ([344f037](https://github.com/asieduernest12/occ/commit/344f0379d8a688108b6c464bdafef115e7e0ee8c))
* **ci:** ensure .tmp dir exists before tee and unignore it ([bb0b63f](https://github.com/asieduernest12/occ/commit/bb0b63f71ec7b8e87b7d5143626745926b64f68b))
* clean out directory before build to prevent permission conflicts ([a7092a5](https://github.com/asieduernest12/occ/commit/a7092a53949e889116c4b87ac72872651f4f634e))
* close browser after each spec test ([6f670e6](https://github.com/asieduernest12/occ/commit/6f670e68f85c0872ba40c36d5a99cf952665c750))
* correct Docker container port to match OpenClaw internal port ([2068bb0](https://github.com/asieduernest12/occ/commit/2068bb0cf0a6132fe5caccb6598f6da1c1381f2d))
* correct YAML syntax in docker-compose.openclaw.override.yml ([c82c2d8](https://github.com/asieduernest12/occ/commit/c82c2d8b3d287bfc12105b6b3258f1218bcd4b0b))
* deeplinking working and showing setup cards after signup. hurray ([fbb5ce8](https://github.com/asieduernest12/occ/commit/fbb5ce8cfb82c0defe7ce2823a26f37c24f3f2b4))
* deprecate docker run, enforce docker-compose.openclaw.yml as single source of truth ([a9536e8](https://github.com/asieduernest12/occ/commit/a9536e8fc6d24d4be94966366a06c147c86261fb))
* **docker-compose:** migrate all docker run commands to docker-compose ([b0ec609](https://github.com/asieduernest12/occ/commit/b0ec6099eee929a53020b57bcf12cf728916c85e))
* **docker-setup:** fix missing/broken buttons in provisioning error view ([c28e80a](https://github.com/asieduernest12/occ/commit/c28e80a99bf407988bb963b217539f4c01b362fc))
* **docker-setup:** make image field optional, fall back to default ([bca51a3](https://github.com/asieduernest12/occ/commit/bca51a35a9bfe26293632106d64ef43a3426ea5a))
* **docker-setup:** prevent reload loop on gateway auto-detection ([ad0cac9](https://github.com/asieduernest12/occ/commit/ad0cac91da902e7ec7b46955ec553a3e5ac1e72a))
* **docker-setup:** restore routing to DockerSetupPanel on docker card click ([4725166](https://github.com/asieduernest12/occ/commit/4725166514169127214e64043f71bba90d2f0650))
* **docker:** migrate setup panel from docker-compose V1 to docker compose V2 and use canonical compose file ([0d7f38c](https://github.com/asieduernest12/occ/commit/0d7f38c5dba3539dc2fd2eb895280b7f18ac3948))
* **docker:** show full status panel instead of install screen ([23f8feb](https://github.com/asieduernest12/occ/commit/23f8febead0efb350dd2276d5cd161055b6301fd))
* ensure all tests navigate to workspace‑aware URL to load OCC extension (VSCODE_WORKSPACE_URL redirect) ([d8a846d](https://github.com/asieduernest12/occ/commit/d8a846ddd00e8fb3b2cb749afcee2d24ae221a24))
* explicitly close CDP sessions and pages after each test ([1fead7e](https://github.com/asieduernest12/occ/commit/1fead7e1505d4359960ac2725567528655774c72))
* fetch download URLs client-side to fix stale versions on static export ([d1caa85](https://github.com/asieduernest12/occ/commit/d1caa85b42a136b6a320acbbec72a5a2ef9f697b))
* **home:** skip host-picker on first load if gateway or Docker detected ([da43069](https://github.com/asieduernest12/occ/commit/da43069a23957ea9e9cc199e468fffb7f232a26a))
* Improve data directory display and debugging on Docker setup ([1692e02](https://github.com/asieduernest12/occ/commit/1692e02048cac7c1ad08ef57e880087d205b58a2))
* increase E2E test timeouts and improve page navigation reliability ([4669e93](https://github.com/asieduernest12/occ/commit/4669e93fd653d6e66e3ac0402f136e114048187f))
* **install:** parallelize postinstall and cascade from root npm install ([a517b67](https://github.com/asieduernest12/occ/commit/a517b67cf1566e330082d8275443b1a48f66ae5b))
* **make:** redundant build of linux docker image' ([f9debf4](https://github.com/asieduernest12/occ/commit/f9debf4547b40646d20f4dd291c9c8458b7629c9))
* MultiHost Docker panel — eliminate setActiveHost race causing host-selector bounce ([9df099a](https://github.com/asieduernest12/occ/commit/9df099a36bdbadeb981c77a79f945fc560ac6c65))
* **multihost:** correct adapter extension main paths after TS rootDir inference ([13b332a](https://github.com/asieduernest12/occ/commit/13b332a5c53e1d7113921f95ab2f90ce3a30327f))
* only close CDP sessions that the test created ([b169545](https://github.com/asieduernest12/occ/commit/b169545e557608a8b9724a77208553c8eaf60ccc))
* **openclaw-docker:** resolve EACCES in docker-in-docker gateway setup ([0aac765](https://github.com/asieduernest12/occ/commit/0aac7650333735e2487366465f661ac1a099b8b9))
* **openclaw:** stop setup panel from mounting gateway data dir as root ([485e3eb](https://github.com/asieduernest12/occ/commit/485e3ebddd66a09298bd1850f133fd50da87bdb6))
* persist onboarding error logs instead of hiding them + add view button ([cff7ff6](https://github.com/asieduernest12/occ/commit/cff7ff6738f37c091ca001f4e7142c680c8a76f6))
* remove unnecessary port rewriting in extension URL handling ([56b4aa3](https://github.com/asieduernest12/occ/commit/56b4aa35e3774023de604005b6dd45b8c14f4c47))
* resolve E2E test fixture URL handling in CDP mode ([da4e1bf](https://github.com/asieduernest12/occ/commit/da4e1bfeff3fd5950409b9c7c74bb652291b90c2))
* Resolve npm ENOENT and EACCES errors in multi-user Docker environment ([8f89147](https://github.com/asieduernest12/occ/commit/8f891472dbc70d6bb5f984634f03fe38062cd4fb))
* Resolve npm lookup failures in multi-user environments ([ead60f4](https://github.com/asieduernest12/occ/commit/ead60f425c4545da7f2369345bcc9a03ef48e818))
* skip node install if higher version already available ([ac0307c](https://github.com/asieduernest12/occ/commit/ac0307c2aa814941fde94cdd6cb27a0e5dedde5d))
* **ssh:** verify install script integrity before execution ([35470ff](https://github.com/asieduernest12/occ/commit/35470ff7ac3b0f61c88099f201d378ef5be4e821))
* **ticket-040:** wire Docker card to 3-step config modal ([012c4eb](https://github.com/asieduernest12/occ/commit/012c4eb70ee010587fe9c9b4218f3089e3f00eda))
* **ticket-040:** wire Docker card to config modal ([29cde87](https://github.com/asieduernest12/occ/commit/29cde872e7c152ba3b3b57237ef262c79b870972))
* **ui:** add missing webview message handler for 'Open Web Control' button ([8ace6cd](https://github.com/asieduernest12/occ/commit/8ace6cd171975e180a0d4533d9eb7816f1a3a571))
* use configured host port when opening docker dashboard ([6340ad4](https://github.com/asieduernest12/occ/commit/6340ad4c43645157c6aead2de5bc86be968a8f06))
...
## [3.4.3](https://github.com/asieduernest12/occ/compare/v3.4.2...v3.4.3) (2026-04-04)
